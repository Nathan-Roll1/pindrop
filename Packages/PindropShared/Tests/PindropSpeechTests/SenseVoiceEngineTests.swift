...
struct SenseVoiceEngineTests {
    ...
    @Test func catalogExposesSenseVoiceModel() throws {
        let manager = ModelManager(storageLocations: try SpeechTestSupport.makeStorageLocations().locations)
    ...
    @Test func transcriptionServiceFactoryRoutesSenseVoiceToSenseVoiceEngine() async throws {
