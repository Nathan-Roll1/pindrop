...
public enum BuiltInPresets: Sendable {
    ...
    public struct PresetExample: Equatable, Sendable {
    ...
    public struct PresetDefinition: Identifiable, Equatable, Sendable {
        public let identifier: String
        public let name: String
        public let prompt: String
        /// Optional before/after sample for UI. English source only; localize for display.
        public let example: PresetExample?
    ...
    public static let all: [PresetDefinition] = [
        cleanTranscript,
    ...
    public static let defaultPreset: PresetDefinition = cleanTranscript

    /// Look up a built-in definition by stable identifier.
    public static func definition(for identifier: String) -> PresetDefinition? {
        all.first { $0.identifier == identifier }
    }

    /// Canonical English prompt text for a built-in identifier, if known.
    public static func englishPrompt(for identifier: String) -> String? {
    ...
    public static func normalizedPromptOverride(
        _ override: String?,
        presetID: String? = nil
    ) -> String? {
    ...
    public static func resolvedEnglishPrompt(
        override: String?,
        presetID: String?,
        fallback: String
    ) -> String {
    ...
    public static func isKnownEnglishBuiltInOrDefaultPrompt(_ text: String) -> Bool {
        let trimmed = text.trimmingCharacters(in: .whitespacesAndNewlines)
        if promptsMatch(trimmed, AIEnhancementDefaults.transcriptionPrompt) { return true }
        if promptsMatch(trimmed, AIEnhancementDefaults.notePrompt) { return true }
        if promptsMatch(trimmed, AIEnhancementDefaults.systemPrompt) { return true }
    ...
    public static func matchingBuiltInIdentifier(for text: String) -> String? {
        let trimmed = text.trimmingCharacters(in: .whitespacesAndNewlines)
    ...
    public static let liveStreamingRefinement = PresetDefinition(
    ...
    public static let liveStreamingRefinementEdits = PresetDefinition(
    ...
    public static let cleanTranscript = PresetDefinition(
        identifier: "clean",
    ...
    public static let meetingNotes = PresetDefinition(
        identifier: "meeting",
        name: "Meeting Notes",
        prompt: """
    ...
    public static let emailDraft = PresetDefinition(
        identifier: "email",
        name: "Email Draft",
        prompt: """
    ...
    public static let socialMedia = PresetDefinition(
        identifier: "social",
        name: "Social Media",
        prompt: """
    ...
    public static let bulletSummary = PresetDefinition(
        identifier: "bullets",
        name: "Bullet Summary",
        prompt: """
    ...
    public static let technical = PresetDefinition(
