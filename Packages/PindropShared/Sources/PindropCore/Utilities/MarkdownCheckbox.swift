...
public enum MarkdownCheckbox {
    ...
    public static func toggle(in text: String, utf16Offset: Int) -> String? {
    ...
    public static func toggleLine(in text: String, lineIndex: Int) -> String? {
    ...
    public static func applyingToggle(to text: String, match: Match) -> String {
        let nsText = text as NSString
