...
public struct AppliedEditReport: Equatable, Sendable {
   public let resultingText: String
   public let applied: Int
   public let skippedFindNotPresent: Int
   public let skippedFindAmbiguous: Int
   public let skippedFindExtendsBeyondInput: Int
   public let skippedNoOp: Int

   public init(
      resultingText: String,
      applied: Int,
      skippedFindNotPresent: Int,
      skippedFindAmbiguous: Int,
      skippedFindExtendsBeyondInput: Int,
      skippedNoOp: Int
   ) {
      self.resultingText = resultingText
      self.applied = applied
      self.skippedFindNotPresent = skippedFindNotPresent
      self.skippedFindAmbiguous = skippedFindAmbiguous
      self.skippedFindExtendsBeyondInput = skippedFindExtendsBeyondInput
      self.skippedNoOp = skippedNoOp
   }

   /// Convenience: true when at least one edit actually changed the text.
   public var didChange: Bool { applied > 0 }
