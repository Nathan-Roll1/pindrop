...
public struct DeterministicTranscriptCleaner: Sendable {
   ...
   /// pass.
   public static let fillerTokens: Set<String> = [
      "um", "uh", "erm", "hmm", "hm",
   ]
   ...
   public static func capitalizeStandaloneI(_ text: String) -> String {
      guard !text.isEmpty else { return text }
   ...
   /// left untouched.
   public static func applySentenceCase(_ text: String, startOfUtterance: Bool = true) -> String {
      guard !text.isEmpty else { return text }
   ...
   public static func replaceSpokenPunctuation(_ text: String, priorWord: String? = nil)
      -> String
   {
      guard !text.isEmpty else { return text }
   ...
   /// fixes.
   public static func normalizeCompoundNumberWords(_ text: String) -> String {
      guard !text.isEmpty else { return text }
   ...
   public static func mergeSplitSuffixes(_ text: String) -> String {
      guard !text.isEmpty else { return text }
