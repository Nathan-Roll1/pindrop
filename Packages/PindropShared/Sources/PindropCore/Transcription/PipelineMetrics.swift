...
public enum PipelineKind: String, Codable, Sendable {
    case batch
    case streaming
}
...
public struct PipelineMetrics: Codable, Equatable, Sendable {
    ...
    public var audioStopSeconds: Double?
    ...
    public var textProcessingSeconds: Double?
    ...
    public var enhancementRequestSeconds: Double?
    ...
    public var enhancementProvider: String?
    public var enhancementModel: String?
    public var enhancementPromptTokens: Int?
    public var enhancementCompletionTokens: Int?
    /// Reasoning/thinking tokens when the provider reports them
    /// (OpenAI `completion_tokens_details.reasoning_tokens`).
    public var enhancementReasoningTokens: Int?
    public var enhancementTotalTokens: Int?
    ...
    public init(
        kind: PipelineKind,
        audioStopSeconds: Double? = nil,
        transcriptionSeconds: Double? = nil,
        textProcessingSeconds: Double? = nil,
        enhancementSeconds: Double? = nil,
        enhancementRequestSeconds: Double? = nil,
        outputSeconds: Double? = nil,
        totalSeconds: Double? = nil,
        enhancementProvider: String? = nil,
        enhancementModel: String? = nil,
        enhancementPromptTokens: Int? = nil,
        enhancementCompletionTokens: Int? = nil,
        enhancementReasoningTokens: Int? = nil,
        enhancementTotalTokens: Int? = nil
    ) {
        self.kind = kind
        self.audioStopSeconds = audioStopSeconds
        self.transcriptionSeconds = transcriptionSeconds
        self.textProcessingSeconds = textProcessingSeconds
        self.enhancementSeconds = enhancementSeconds
        self.enhancementRequestSeconds = enhancementRequestSeconds
        self.outputSeconds = outputSeconds
        self.totalSeconds = totalSeconds
        self.enhancementProvider = enhancementProvider
        self.enhancementModel = enhancementModel
        self.enhancementPromptTokens = enhancementPromptTokens
        self.enhancementCompletionTokens = enhancementCompletionTokens
        self.enhancementReasoningTokens = enhancementReasoningTokens
        self.enhancementTotalTokens = enhancementTotalTokens
    }
