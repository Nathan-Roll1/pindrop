//
//  WaveformPeaks+Extraction.swift
//  PindropMedia
//
//  Created on 2026-07-09.
//
//  AVFoundation/Accelerate extraction and coalesced loading. Sidecar
//  URL/JSON read-write/delete lives in PindropCore.WaveformPeaks.
//
...
extension WaveformPeaks {
    ...
    public static let extractionChunkFrames: AVAudioFrameCount = 16_384
    ...
    public static func extract(from audioURL: URL, bucketCount: Int = defaultBucketCount) throws -> [Float] {
    ...
    public static func peaks(from buffer: AVAudioPCMBuffer, bucketCount: Int) -> [Float] {
        let buckets = max(bucketCount, 1)
...
public enum WaveformPeaksLoader {
...
public enum WaveformPeaksError: Error, LocalizedError {
