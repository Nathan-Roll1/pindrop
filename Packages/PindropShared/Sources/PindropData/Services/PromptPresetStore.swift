...
public final class PromptPresetStore {
    ...
    public enum PromptPresetStoreError: Error, LocalizedError {
    ...
    public func fetchAll() throws -> [PromptPreset] {
    ...
    public func fetchBuiltIn() throws -> [PromptPreset] {
    ...
    public func fetchCustom() throws -> [PromptPreset] {
    ...
    public func resolvePrompt(for identifier: String?) throws -> String? {
    ...
    public func add(_ preset: PromptPreset) throws {
    ...
    public func update(_ preset: PromptPreset) throws {
    ...
    public func delete(_ preset: PromptPreset) throws {
    ...
    public func duplicate(_ preset: PromptPreset, withPrompt prompt: String? = nil) throws -> PromptPreset {
    ...
    public func seedBuiltInPresets() throws {
