...
enum TranscriptionRecordSchemaV7: VersionedSchema {
    static var versionIdentifier = Schema.Version(1, 0, 6)
...
enum TranscriptionRecordSchemaV8: VersionedSchema {
...
enum TranscriptionRecordSchemaV9: VersionedSchema {
    static var versionIdentifier = Schema.Version(1, 0, 8)
...
enum TranscriptionRecordSchemaV11: VersionedSchema {
    static var versionIdentifier = Schema.Version(1, 0, 10)
...
public enum TranscriptionRecordSchemaV12: VersionedSchema {
    public static var versionIdentifier = Schema.Version(1, 0, 11)
    ...
    public final class ParticipantProfile {
        ...
        public var centroidEmbeddingData: Data?
        public var evidenceCount: Int
        public var totalEvidenceDuration: TimeInterval
        public var embeddingSpaceIdentifier: String?
        public var needsVoiceRetraining: Bool = false
        public var createdAt: Date
        public var updatedAt: Date
        public var evidence: [ParticipantTrainingEvidence]
    ...
    @Model
    public final class ParticipantTrainingEvidence {
        @Attribute(.unique) public var id: UUID
        @Attribute(.unique) public var evidenceKey: String
        public var sourceTypeRawValue: String
        public var recordID: UUID?
        public var sourceSpeakerID: String
        public var segmentStartTime: TimeInterval
        public var segmentEndTime: TimeInterval
        ...
        public var createdAt: Date
        public var updatedAt: Date
        public var profile: ParticipantProfile?
    ...
    public final class TranscriptionRecord {
        ...
        public var diarizationSegmentsJSON: String?
        public var sourceKindRawValue: String?
        public var sourceDisplayName: String?
        public var generatedTitle: String?
        public var aiSummary: String?
        public var sourceTitleOriginRawValue: String?
        public var originalSourceURL: String?
        public var managedMediaPath: String?
        public var thumbnailPath: String?
        public var folder: MediaFolder?
        public var destinationAppName: String?
        public var destinationAppBundleID: String?
        ...
        public var pipelineMetricsJSON: String?
        @Transient public var wasEnhanced: Bool = false
        @Transient public var sourceKind: MediaSourceKind = .voiceRecording
...
enum TranscriptionRecordMigrationPlan: SchemaMigrationPlan {
    ...
    // Adds optional AI title/summary metadata and source-title provenance.
    static let migrateV6toV7 = MigrationStage.lightweight(
        fromVersion: TranscriptionRecordSchemaV6.self,
        toVersion: TranscriptionRecordSchemaV7.self
    )

    // Lightweight migration from V7 to V8.
    // Adds optional destination-app metadata and cached word count.
    static let migrateV7toV8 = MigrationStage.lightweight(
        fromVersion: TranscriptionRecordSchemaV7.self,
        toVersion: TranscriptionRecordSchemaV8.self
    )

    // Lightweight migration from V8 to V9.
    // Adds optional profile notes and a current-user marker with a false default.
    ...
    // Adds the opt-in training-contribution table and an optional manual-edit
    // timestamp on transcription records.
