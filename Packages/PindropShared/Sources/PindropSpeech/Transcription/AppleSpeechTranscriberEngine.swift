...
//
//  macOS 26+ / iOS 26+ streaming backend built on Speech.SpeechAnalyzer + SpeechTranscriber.
...
//
//  Below OS 26, hosts should keep using Nemotron / Parakeet streaming (or batch
//  `AppleSpeechEngine` via SFSpeechRecognizer on the package floors).
//
