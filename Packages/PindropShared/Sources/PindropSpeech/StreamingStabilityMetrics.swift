...
public struct StreamingStabilityMetrics: Sendable {
    ...
    public mutating func recordPartial(_ text: String) {
    ...
    public mutating func recordFinal(_ text: String) {
        finalText = text
    }
    ...
    public mutating func recordDisplayUpdate(_ displayed: String) {
    ...
    public var unstablePartialWordRatio: Double {
    ...
    public var retypeBytesPerWord: Double {
    ...
    public func summaryLine(sessionNumber: Int) -> String {
        String(
            format:
    ...
    /// so "hello," and "hello" stay equivalent for counting purposes.
